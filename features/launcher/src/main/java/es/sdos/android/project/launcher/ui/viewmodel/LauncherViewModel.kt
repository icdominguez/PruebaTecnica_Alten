...
class LauncherViewModel @Inject constructor(private val synchronizeGamesUseCase: SynchronizeGamesUseCase, private val dispatchers: AppDispatchers) : BaseViewModel() {
